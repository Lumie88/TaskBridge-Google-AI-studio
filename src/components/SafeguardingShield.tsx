...
export default function SafeguardingShield() {
  ...
  return (
    <section id="safeguarding" className="bg-slate-900 text-white py-20 lg:py-28 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[30%] right-0 h-[400px] w-[400px] rounded-full bg-rose-500/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-[20%] left-0 h-[400px] w-[400px] rounded-full bg-indigo-500/10 blur-3xl pointer-events-none" />
            ...
            <div className="mt-8 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-950 border border-slate-700/60 p-6 flex items-start gap-4 shadow-xl">
              ...
              <div>
                ...
                <p className="font-sans text-xs text-slate-400 mt-1 leading-relaxed">
                  We verify trade insurance, monitor contractor coordinates dynamically during visits, and require live photo proofing before payment clearance occurs. Zero un-audited work, ever.
                </p>
              </div>
            </div>
          </div>
