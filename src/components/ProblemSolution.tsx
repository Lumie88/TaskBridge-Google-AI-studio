...
import { SOLUTION_STEPS } from "../types";
...
export default function ProblemSolution() {
  ...
  return (
    <section id="how-it-works" className="bg-slate-50 py-20 lg:py-28 relative">
      ...
      <div className="absolute top-[30%] left-0 h-[300px] w-[300px] rounded-full bg-rose-100/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-[10%] right-0 h-[400px] w-[400px] rounded-full bg-amber-100/10 blur-3xl pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-20">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between rounded-3xl border border-rose-100 bg-rose-50/20 p-8 sm:p-10 shadow-sm relative overflow-hidden">
            <div className="absolute -right-16 -top-16 h-32 w-32 rounded-full bg-rose-500/5 blur-xl" />
          ...
          <div className="lg:col-span-6 flex flex-col justify-between rounded-3xl border border-slate-900 bg-slate-950 p-8 sm:p-10 text-white relative overflow-hidden shadow-xl">
            {/* Soft Warm Gradients inside dark card */}
            <div className="absolute -right-24 -top-24 h-64 w-64 rounded-full bg-rose-500/10 blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-slate-50 rounded-2xl border border-slate-100 p-6 md:p-8">
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xl relative overflow-hidden text-left">
                <div className="absolute top-0 right-0 h-24 w-24 rounded-full bg-gradient-to-br from-rose-500/5 to-amber-500/5 blur-xl pointer-events-none" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">Before-and-after photo records auto-logged for statutory CQC regulators.</p>
                    </div>
                  </div>

                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                    <span>Evidence Record:</span>
                    <span className="font-sans font-semibold text-xs text-rose-650 underline">
